...
export interface ApiHobbyHobby extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hobbies displayed in The Gap section';
    displayName: 'Hobby';
    pluralName: 'hobbies';
    singularName: 'hobby';
  };
  ...
  attributes: {
    ...
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'book'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPhotoCategoryPhotoCategory
  ...
  info: {
    description: 'Categories for photos (Infancy, Toddler Years, College, etc.)';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['childhood', 'college']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings for the biography';
